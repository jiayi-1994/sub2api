        ...
        <div class="space-y-1.5">
          ...
          <div class="mb-2 border-b border-gray-700 pb-1.5">
            ...
            <div v-if="tooltipData && tooltipData.input_cost > 0" class="flex items-center justify-between gap-4">
              ...
              <span class="font-medium text-white">${{ calculateDiscountedUsageCost(tooltipData.input_cost, tooltipData).toFixed(8) }}</span>
            </div>
            <div v-if="tooltipData && hasImageInputCost(tooltipData)" class="flex items-center justify-between gap-4">
              ...
              <span class="font-medium text-fuchsia-300">${{ calculateDiscountedUsageCost(tooltipData.image_input_cost, tooltipData).toFixed(8) }}</span>
            </div>
            <div v-if="tooltipData && tooltipData.output_cost > 0" class="flex items-center justify-between gap-4">
              <span class="text-gray-400">{{ t('admin.usage.outputCost') }}</span>
              <span class="font-medium text-white">${{ calculateDiscountedUsageCost(tooltipData.output_cost, tooltipData).toFixed(8) }}</span>
            </div>
            <div v-if="tooltipData && hasImageOutputCost(tooltipData)" class="flex items-center justify-between gap-4">
              ...
              <span class="font-medium text-pink-300">${{ calculateDiscountedUsageCost(tooltipData.image_output_cost, tooltipData).toFixed(8) }}</span>
            </div>
            ...
            <div v-if="tooltipData && tooltipData.cache_creation_cost > 0" class="flex items-center justify-between gap-4">
              ...
              <span class="font-medium text-white">${{ calculateDiscountedUsageCost(tooltipData.cache_creation_cost, tooltipData).toFixed(8) }}</span>
            </div>
            <div v-if="tooltipData && tooltipData.cache_read_cost > 0" class="flex items-center justify-between gap-4">
              <span class="text-gray-400">{{ t('admin.usage.cacheReadCost') }}</span>
              <span class="font-medium text-white">${{ calculateDiscountedUsageCost(tooltipData.cache_read_cost, tooltipData).toFixed(8) }}</span>
            </div>
          </div>
          <!-- Rate and Summary -->
...
import { calculateDiscountedUsageCost, formatTokenPricePerMillion } from '@/utils/usagePricing'
