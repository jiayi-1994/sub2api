...
import { calculateDiscountedUsageCost } from '@/utils/usagePricing'
  ...
  try {
    ...
    while (true) {
      ...
      const rows = (res.items || []).map((log: AdminUsageLog) => [
        ...
        calculateDiscountedUsageCost(log.input_cost, log).toFixed(6), calculateDiscountedUsageCost(log.output_cost, log).toFixed(6),
        calculateDiscountedUsageCost(log.cache_read_cost, log).toFixed(6), calculateDiscountedUsageCost(log.cache_creation_cost, log).toFixed(6),
