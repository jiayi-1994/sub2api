...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		GlobalBillingRateMultiplier:                            settings.GlobalBillingRateMultiplier,
...
type UpdateSettingsRequest struct {
	...
	GlobalBillingRateMultiplier               *float64                          `json:"global_billing_rate_multiplier"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	globalBillingRateMultiplier := previousSettings.GlobalBillingRateMultiplier
	if req.GlobalBillingRateMultiplier != nil {
		globalBillingRateMultiplier = *req.GlobalBillingRateMultiplier
	}
	if globalBillingRateMultiplier < 0 {
		globalBillingRateMultiplier = 0
	}
	...
	settings := &service.SystemSettings{
		...
		GlobalBillingRateMultiplier:            globalBillingRateMultiplier,
	...
	payload := dto.SystemSettings{
		...
		GlobalBillingRateMultiplier:                            updatedSettings.GlobalBillingRateMultiplier,
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.GlobalBillingRateMultiplier != after.GlobalBillingRateMultiplier {
		changed = append(changed, "global_billing_rate_multiplier")
	}
